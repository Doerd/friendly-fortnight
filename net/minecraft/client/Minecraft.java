...
import doerd.main.GuiIngameHook;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        // Doerd Initialization
        doerd = new Doerd();
        
        
        // Doerd changed GUI to know what's on
    ...
    private void clickMouse()
    {
    	...
    	if(teleport){
    		Vector vec = new Vector(this.thePlayer.rotationPitch, this.thePlayer.rotationYaw);
    		double newX = this.thePlayer.posX + scaling*vec.getX();
    		double newY = this.thePlayer.posY + scaling*vec.getY();
